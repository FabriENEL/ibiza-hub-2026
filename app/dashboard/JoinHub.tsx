  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white flex flex-col items-center p-6 pt-12">
      <div className="w-full max-w-sm space-y-5">
        ...
        <h1 className="text-2xl font-black text-yellow-500 uppercase tracking-widest">Entra con codice</h1>
        <p className="text-slate-400 text-sm">Inserisci il codice invito che ti ha dato l'organizzatore.</p>

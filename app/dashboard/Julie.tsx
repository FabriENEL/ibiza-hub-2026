    ...
    <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center bg-black/60 backdrop-blur-sm" onClick={softClose}>
      <div onClick={(e) => e.stopPropagation()}
        ...
        <div className="flex items-center gap-3.5 p-4 border-b border-white/10" style={{ background: 'linear-gradient(180deg, rgba(163,181,133,0.10), transparent)' }}>
          <div className={'relative shrink-0 w-14 h-14 rounded-full overflow-hidden shadow-lg shadow-black/40 ' + (busy ? 'animate-[eg-breathe_1.6s_ease-in-out_infinite]' : 'animate-[eg-breathe_4s_ease-in-out_infinite]')} style={{ border: '2px solid rgba(163,181,133,0.55)' }}>
            <img src="/julie-avatar.jpeg" alt="J.U.L.I.E." className="w-full h-full object-cover scale-125" />
          </div>

  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-blue-900/20 border border-blue-500/20 p-4 rounded-xl">
        ...
        {transfers.length === 0 ? <p className="text-xs text-slate-500">Tutti in pari.</p> : transfers.map((tr, k) => (
      ...
      <div className="bg-slate-900 p-4 rounded-xl">
        ...
        {expenses.length === 0 ? <p className="text-xs text-slate-500">Nessuna spesa.</p> : expenses.map((e) => (
